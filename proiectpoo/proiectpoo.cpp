...
void Film::citire() {
    ...
    {
        ignora_linia();
        cout << "Valoare invalida,reintroduceti valoarea : ";
        cin >> imdb_rating;
    }
...
void calculeaza_vizionari_primele_2(const vector<Film>& filme) {
    ...
    for (size_t i = 0; i < filme.size() && i < 3; i++) {
        suma_vizionari += filme[i].vizionari_cinema;
    }
    cout << "Suma filmelor este de : " << suma_vizionari << endl << endl << endl;
...
int main() {
    ...
    while (ok != "4")
    {
        ...
        cout << "2. Suma primelor 2 filme." << endl;
        ...
        else if (ok == "4")
        {
            ...
            cout << "Pagina selectat nu exista! (Reintroduce-ti numarul paginii).";
    }
